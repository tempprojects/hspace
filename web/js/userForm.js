...
jQuery( document ).ready(function($) {
    ...
    var avatar_image=$("#users-avatar").val();
    
    if(avatar_image){
        $("#dropzone0").css("background", "url('http://localhost/yii2_hspace/frontend/web/media/profile/avatar/" + avatar_image + "')");
    }
    ...
    if(dropzone){
        ...
        $(".input_image_faile").change( function(event) {
            ...
            $(".field-users-avatar input").val(image_name);
        });
